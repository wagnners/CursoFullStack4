  ...
  <div class="d-flex h-100 w-100 mx-auto flex-column">
      ...
      <main role="main">
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img src="assets/img/por_do_sol.jpg" class="d-block w-100 img-fluid" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/por_do_sol_2.jpg" class="d-block w-100 img-fluid" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/por_do_sol_3.jpg" class="d-block w-100 img-fluid" alt="...">
        ...
        <section class="section2 my-5">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 mb-5 mb-lg-0 mb-md-0"><div class="imagem imagem1"></div></div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 mb-5 mb-lg-0 mb-md-0"><div class="imagem imagem2"></div></div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 mb-5 mb-lg-0 mb-md-0"><div class="imagem imagem3"></div></div>
              </div>
            </div>
        </section>
      ...
      <footer class="text-center py-5">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 mb-5 mb-lg-0 mb-md-0">
              <h5>Menu</h5>
              <ul>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 mb-3 mb-lg-0 mb-md-0">
              <h5>Redes Sociais</h5>
              <div class="row">
                <div class="col-6">
